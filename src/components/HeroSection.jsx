      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-16 mb-12">
        ...
        <div className="flex-1 text-left">
          <p className="text-gray-400 text-base sm:text-lg leading-relaxed mb-8">
            At AU Research Hub, we empower architectural innovation by curating, supporting, 
            and publishing groundbreaking academic work from leading researchers around the world.
          </p>
